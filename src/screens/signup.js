                ...
                <KeyboardAvoidingView behavior={Platform.OS === "ios"?"padding":"height"}>
                    <ScrollView showsVerticalScrollIndicator={false} className="h-full">
                        ...
                        <View className="w-full px-4 flex my-3 items-center gap-2">
                                <TextInput placeholder="john doe" className="border rounded-sm w-80 p-2"/>
                            </View>
                            <View className="w-full px-4 flex my-3 items-center gap-2">
                                <TextInput placeholder="enter email" className="border rounded-sm w-80 p-2"/>
                            </View>
                            <View className="w-full px-4 flex my-3 items-center gap-2">
                                <TextInput placeholder="enter phone" className="border rounded-sm w-80 p-2"/>
                            </View>
                            ...
                            <View className="w-full px-4 my-3 flex items-center gap-2">
                                <TextInput placeholder="re-enter password" className="border rounded-sm w-80 p-2"/>
                            </View>
                            <View className="px-2 my w-full items-center">
                                <TouchableOpacity className="bg-blue-500 items-center justify-center h-10 rounded-sm w-80">
